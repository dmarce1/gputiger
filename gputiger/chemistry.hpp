...
__device__
static void saha(const cosmic_parameters &opts, double rho, double T, double &H, double &Hp, double &He, double &Hep, double &Hepp, double &ne) {
...
__device__
static void chemistry_update(const cosmic_parameters &opts, const nvstd::function<double(double)> &Hubble, double &H, double &Hp, double &He, double &Hep, double &Hepp,
